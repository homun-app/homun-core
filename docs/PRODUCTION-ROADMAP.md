...
| **Sito homun.dev** | ⏸️ maintainer pending | Repo separato `homun-app/docs`, refresh pending maintainer Fase B |
...
**Risultato Fase A (Claude)**: 5 commit puliti preparano tutto quello che si può preparare senza accesso a VM / GitHub UI / homun.dev repo.
...
5. ⏸️ `homun.dev` sito refresh (repo separato `homun-app/docs`)
