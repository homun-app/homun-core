...
| `crates/desktop-gateway/src/gateway_actionable_source.rs` | Claim one-shot, risoluzione e rewrite terminale della source card assistant collegata al task; non possiede execute pending, payment approval, remote approval dispatch/cancel o browser. |
