...
| `crates/desktop-gateway/src/gateway_usage_runtime.rs` | Bootstrap runtime del ledger usage: open store, cleanup attempt orfani, rebuild rollup, recorder buffered, snapshot pricing e registrazione process-wide; non possiede route HTTP usage o model registry. |
