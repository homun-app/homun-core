...
| `crates/desktop-gateway/src/gateway_remote_approval.rs` | Marker parsing remote approval, event parts persistiti, actionable card extraction, creazione pending approval, scadenza, controllo codice pending, parsing risposte OK/NO e testo progresso canale; non possiede execute pending, dispatch remoto, payment approval o browser. |
