...
| INST-4 | **Homebrew formula** | ✅ DONE 2026-04-14 | `packaging/brew/homun.rb.template` — hybrid binary-bottle + source-fallback. Tap repo `homun-app/homebrew-tap` setup manuale (documentato in `packaging/brew/README.md`) |
