...
(function () {
    ...
    // ─── Section registry ───
    var SECTIONS = [
        { id: 'account',     label: 'Account',           group: null,       icon: '<svg viewBox="0 0 18 18" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="9" cy="6" r="3.5"/><path d="M3 17c0-3.5 2.5-6 6-6s6 2.5 6 6"/></svg>', scripts: ['account.js', 'account-gateways.js', 'account-mobile.js'] },
        ...
        { id: 'traces',      label: 'Request Analysis',  group: 'System',   icon: '<svg viewBox="0 0 18 18" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="5" cy="9" r="2"/><circle cx="13" cy="4" r="2"/><circle cx="13" cy="14" r="2"/><path d="M7 9h2M11 4.8l-2 2.7M11 13.2l-2-2.7"/></svg>', scripts: ['traces.js'] },
