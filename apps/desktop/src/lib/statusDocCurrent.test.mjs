...
test("status doc records the merged runtime view model turn contract", () => {
  ...
  assert.match(statusDoc, /main` aggiornato a #394 \(`f05f37e3`\)/);
...
test("status doc records the open preview thread fallback cleanup slice", () => {
  assert.match(statusDoc, /#395 `Remove preview fallback from chat thread creation`/);
