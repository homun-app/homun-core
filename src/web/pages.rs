...
async fn automations_page() -> Html<String> {
    let body = r#"<main class="content">
            ...
            <div id="automations-builder-view" class="builder-view">
                <div class="builder-header">
                    <div class="builder-header-left">
                        ...
                        <input type="text" id="builder-automation-name" class="input builder-name-input" placeholder="My New Automation">
                    </div>
                    <div class="builder-header-right">
                        ...
                        <button type="button" class="topbar-avatar-btn" title="Menu">
                            <img class="topbar-avatar-img" src="/api/v1/account/avatar" alt=""
                                 onerror="this.style.display='none';this.nextElementSibling.style.display='flex'">
                            <span class="topbar-avatar-fallback">
                                <svg viewBox="0 0 18 18" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="9" cy="6" r="3.5"/><path d="M3 17c0-3.5 2.5-6 6-6s6 2.5 6 6"/></svg>
                            </span>
                ...
                <div class="builder-body">
                    ...
                    <div class="builder-palette">
                        <div id="builder-palette-items" class="builder-palette-items">
