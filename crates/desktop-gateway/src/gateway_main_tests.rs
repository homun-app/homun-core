...
fn contact_relationships_are_mirrored_into_canonical_memory_graph() {
    ...
    super::mirror_contact_relationship_to_memory_graph(&facade, &from, &to, "partner_of").unwrap();
...
fn removed_contact_relationship_tombstones_canonical_graph_edge() {
    ...
    super::mirror_contact_relationship_to_memory_graph(&facade, &from, &to, "partner_of").unwrap();
    super::tombstone_contact_relationship_memory_graph_edge(&facade, 1, 2, "partner_of").unwrap();
