...
pub(crate) fn resolve_contained_computer_cdp(
    explicit: Option<&str>,
...
pub(crate) fn contained_computer_cdp_endpoint() -> Option<String> {
...
pub(crate) fn resolve_contained_computer_novnc(
    enabled: bool,
    explicit: Option<&str>,
    server_mode: bool,
) -> Option<String> {
...
pub(crate) struct ComputerReadiness {
    phase: &'static str,
    container_ok: bool,
    cdp_ok: bool,
    novnc_ok: bool,
...
pub(crate) fn computer_readiness(
    container_ok: bool,
    cdp_ok: bool,
    novnc_ok: bool,
    error: Option<&str>,
...
#[derive(Serialize)]
pub(crate) struct LocalComputerActionResponse {
    ok: bool,
    enabled: bool,
...
pub(crate) async fn local_computer_start() -> Json<LocalComputerActionResponse> {
...
pub(crate) async fn local_computer_stop() -> Json<LocalComputerActionResponse> {
...
pub(crate) fn spawn_computer_live_publisher(state: AppState) {
...
pub(crate) async fn contained_cdp_reachable(state: &AppState) -> bool {
    let endpoint =
...
#[test]
fn owner_projects_local_computer_live_readiness() {
    ...
    assert_eq!(
        computer_readiness(true, false, true, None).phase,
        "starting"
    );
    assert_eq!(
        computer_readiness(true, true, false, Some("novnc_unreachable")).phase,
        "failed"
    );
}
