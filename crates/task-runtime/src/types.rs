...
impl TurnEventKind {
    pub fn as_str(&self) -> &'static str {
        match self {
            ...
            TurnEventKind::ChoicePrompt => "choice_prompt",
            TurnEventKind::VaultPropose => "vault_propose",
            TurnEventKind::VaultReveal => "vault_reveal",
            TurnEventKind::PaymentApproval => "payment_approval",
            TurnEventKind::Suspended => "suspended",
    ...
    pub fn parse(s: &str) -> Option<Self> {
        Some(match s {
            ...
            "tool" => Self::Tool,
            "recall" => Self::Recall,
            "choice_prompt" => Self::ChoicePrompt,
            "vault_propose" => Self::VaultPropose,
            "vault_reveal" => Self::VaultReveal,
            "payment_approval" => Self::PaymentApproval,
